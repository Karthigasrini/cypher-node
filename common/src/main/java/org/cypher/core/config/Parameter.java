...
public class Parameter {
  ...
  public static class ChainSymbol {
    ...
    public static final byte[] CYP_SYMBOL_BYTES = "_".getBytes(); // CYP symbol
  }
  ...
  public class ChainConstant {
    ...
    public static final int BLOCK_PRODUCED_INTERVAL = 1000; //ms,produce block period, must be divisible by 60. millisecond
    ...
    public static final long CYP_PRECISION = 1000_000L;
  }
